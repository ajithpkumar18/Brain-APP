...
function Dashboard() {
    ...
    async function handleShare(val: boolean) {
        let response = await axios.post(`${BACKEND_URL}/api/v1/brain/share`, { share: val }, {
            headers: {
        ...
        <div className='flex'>
            ...
            <div className='p-4 w-full min-h-screen bg-gray-200'>
                ...
                <div className='flex justify-end gap-4'>
                    ...
                    <Button onClick={() => handleShare(true)} loading={false} width='normal' variant={"secondary"} text={"Share Brain"} startIcon={<ShareIcon size={"size-4"} />} />
                    <Button onClick={() => handleShare(false)} loading={false} width='normal' variant={"secondary"} text={"Stop Share"} startIcon={<ShareIcon size={"size-4"} />} />
                </div>
